class Atm:
    ...
    def withdrawl1(self,knuts):
        ...
        print("You have withdrawn amount "+str(knuts) + ". remaining balance is "+ str(new_amount))

    def withdrawl2(self,sickles):
        new_amount = 200 - sickles
        print("You have withdrawn amount "+str(sickles) + ". remaining balance is "+ str(new_amount))

    def withdrawl3(self,galleon):
        new_amount = 300 - galleon
        print("You have withdrawn amount "+str(galleon) + ".  remaining balance is "+ str(new_amount))        
